...
const ProductModal = (props) => {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      [FIELDS.IMAGE]: editProduct ? editProduct.image_url : '',
    ...
    onSubmit: async (values) => {
      ...
      const { name, price, description, status, categoryId } = values;
      onSave(name, getBase64Hash, Number(price), description, status, categoryId);
      onClose();
    },
  });
